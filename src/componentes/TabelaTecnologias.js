...
import {PesquisaTecnologia} from './PesquisaTecnologia';
import find from "lodash/find";


export class TabelaTecnologias extends Component {
    ...
    return (
    	<div className="listagemTecnologia">
    		<div className="containerPesquisa">
	    		<PesquisaTecnologia callbackPesquisaTabelaTeste={this.pesquisaTabelaTeste}/>
